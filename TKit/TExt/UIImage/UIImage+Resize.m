...
{
    return [self thumbnailImage:size border:0 radius:0 quality:kCGInterpolationDefault];
}
/// 缩略图
- (UIImage *)thumbnailImage:(CGSize)size
                    quality:(CGInterpolationQuality)quality
{
    return [self thumbnailImage:size border:0 radius:0 quality:quality];
}
/// 缩略图
- (UIImage *)thumbnailImage:(CGSize)thumbnailSize
                     border:(NSUInteger)borderSize
                     radius:(NSUInteger)cornerRadius
                    quality:(CGInterpolationQuality)quality
{
    UIImage *resizedImage = [self resizedImageWithContentMode:UIViewContentModeScaleAspectFill
